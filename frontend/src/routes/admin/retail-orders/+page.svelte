...
<script>
    ...
    function confirmDelete(orderId) {
        ...
        const isConfirmed = window.confirm(`Are you sure you want to delete order #${orderId}? This action cannot be undone / 确定要删除订单 #${orderId} 吗？`);
        return isConfirmed;
    }
</script>
                        ...
                        <tr class="border-b hover:bg-gray-50 transition">
                            ...
                            <td class="p-3">
                                <div class="flex justify-end gap-3">
                                    ...
                                    <!-- ⭐ FIX: Edit/Review (Points to the primary review/edit page) -->
                                    <a 
                                        href={`/admin/retail-orders/${o.id}/review`}
                                    ...
                                    <form method="POST" action="?/delete" class="inline">
                                        ...
                                        <button
                                            ...
                                            on:click={(event) => { 
                                                ...
                                                if (!confirmDelete(o.order_number || o.id)) {
